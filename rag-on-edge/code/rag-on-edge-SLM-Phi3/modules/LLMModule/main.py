...
model_id = os.getenv('hf_model_id', "microsoft/Phi-3-mini-4k-instruct-gguf")
model_filename = os.getenv('hf_model_filename', "Phi-3-mini-4k-instruct-q4.gguf")

model_path = hf_hub_download(repo_id=model_id, filename=model_filename)

llmmodel = LlamaCpp(model_path=model_path, verbose=True, n_threads=N_THREADS)
